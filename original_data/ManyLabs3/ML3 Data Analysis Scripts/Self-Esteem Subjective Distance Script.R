...
require(lmSupport)
modelEffectSizes(SESDmodel6.lm)
plot(allEffects(SESDmodel6.lm))
summary(SESDmodel6.lm)

###Just MTurk
Turk<-subset(SESDdata,SESDdata$Site=="mTurk")
SESDmodelTurk.lm<-lm(SubDist~MonthsSince+SubDistCond+ SelfEsteem +SubDistCond* SelfEsteem,data=Turk)
Anova(SESDmodelTurk.lm,type="II")
modelEffectSizes(SESDmodelTurk.lm)
...
SESDdata$AttentionCheck<-as.factor(SESDdata$AttentionCheck)
AttentionCheck<-lm(SubDist~MonthsSince+SubDistCond*SelfEsteem*AttentionCheck,data=SESDdata)
Anova(AttentionCheck,type="II")
modelEffectSizes(AttentionCheck)
ci.pvaf(F.value= 0.0552,df.1=1,df.2=3101,N=3110,conf.level=.95)
ci.pvaf(F.value= 0.1291,df.1=1,df.2=3101,N=3110,conf.level=.95)
...
summary(SESDinter.inter.lm)
summaryBy(SubDist~SubDistCond,FUN = c(mean,sd), data = Ashland, na.rm=TRUE)
...
Anova(SESDinter.inter.lm,type="II")
summary(SESDinter.inter.lm)
summaryBy(SubDist~SubDistCond,FUN = c(mean,sd), data = Bradley, na.rm=TRUE)
plot(allEffects(SESDinter.inter.lm))
...
Anova(SESDinter.inter.lm,type="II")
summary(SESDinter.inter.lm)
summaryBy(SubDist~SubDistCond,FUN = c(mean,sd), data = Carleton, na.rm=TRUE)
plot(allEffects(SESDinter.inter.lm))
...
Anova(SESDinter.inter.lm,type="II")
summary(SESDinter.inter.lm)
summaryBy(SubDist~SubDistCond,FUN = c(mean,sd), data = Ithaca, na.rm=TRUE)
plot(allEffects(SESDinter.inter.lm))
...
Anova(SESDinter.inter.lm,type="II")
summary(SESDinter.inter.lm)
summaryBy(SubDist~SubDistCond,FUN = c(mean,sd), data = Miami, na.rm=TRUE)
plot(allEffects(SESDinter.inter.lm))
...
Anova(SESDinter.inter.lm,type="II")
summary(SESDinter.inter.lm)
summaryBy(SubDist~SubDistCond,FUN = c(mean,sd), data = MichSt, na.rm=TRUE)
plot(allEffects(SESDinter.inter.lm))
...
Anova(SESDinter.inter.lm,type="II")
summary(SESDinter.inter.lm)
summaryBy(SubDist~SubDistCond,FUN = c(mean,sd), data = Montana, na.rm=TRUE)
plot(allEffects(SESDinter.inter.lm))
...
Anova(SESDinter.inter.lm,type="II")
summary(SESDinter.inter.lm)
summaryBy(SubDist~SubDistCond,FUN = c(mean,sd), data = Nova, na.rm=TRUE)
plot(allEffects(SESDinter.inter.lm))
...
Anova(SESDinter.inter.lm,type="II")
summary(SESDinter.inter.lm)
summaryBy(SubDist~SubDistCond,FUN = c(mean,sd), data = OSU, na.rm=TRUE)
plot(allEffects(SESDinter.inter.lm))
...
Anova(SESDinter.inter.lm,type="II")
summary(SESDinter.inter.lm)
summaryBy(SubDist~SubDistCond,FUN = c(mean,sd), data = PLU, na.rm=TRUE)
plot(allEffects(SESDinter.inter.lm))
...
Anova(SESDinter.inter.lm,type="II")
summary(SESDinter.inter.lm)
summaryBy(SubDist~SubDistCond,FUN = c(mean,sd), data = Penn, na.rm=TRUE)
plot(allEffects(SESDinter.inter.lm))
...
Anova(SESDinter.inter.lm,type="II")
summary(SESDinter.inter.lm)
summaryBy(SubDist~SubDistCond,FUN = c(mean,sd), data = SDSU, na.rm=TRUE)
plot(allEffects(SESDinter.inter.lm))
...
Anova(SESDinter.inter.lm,type="II")
summary(SESDinter.inter.lm)
summaryBy(SubDist~SubDistCond,FUN = c(mean,sd), data = Texas, na.rm=TRUE)
plot(allEffects(SESDinter.inter.lm))
...
Anova(SESDinter.inter.lm,type="II")
summary(SESDinter.inter.lm)
summaryBy(SubDist~SubDistCond,FUN = c(mean,sd), data = Davis, na.rm=TRUE)
plot(allEffects(SESDinter.inter.lm))
...
Anova(SESDinter.inter.lm,type="II")
summary(SESDinter.inter.lm)
summaryBy(SubDist~SubDistCond,FUN = c(mean,sd), data = Riverside, na.rm=TRUE)
plot(allEffects(SESDinter.inter.lm))
...
Anova(SESDinter.inter.lm,type="II")
summary(SESDinter.inter.lm)
summaryBy(SubDist~SubDistCond,FUN = c(mean,sd), data = Florida, na.rm=TRUE)
plot(allEffects(SESDinter.inter.lm))
...
Anova(SESDinter.inter.lm,type="II")
summary(SESDinter.inter.lm)
summaryBy(SubDist~SubDistCond,FUN = c(mean,sd), data = Mississippi, na.rm=TRUE)
plot(allEffects(SESDinter.inter.lm))
...
Anova(SESDinter.inter.lm,type="II")
summary(SESDinter.inter.lm)
summaryBy(SubDist~SubDistCond,FUN = c(mean,sd), data = Toronto, na.rm=TRUE)
plot(allEffects(SESDinter.inter.lm))
...
Anova(SESDinter.inter.lm,type="II")
summary(SESDinter.inter.lm)
summaryBy(SubDist~SubDistCond,FUN = c(mean,sd), data = Virginia, na.rm=TRUE)
plot(allEffects(SESDinter.inter.lm))
...
Anova(SESDinter.inter.lm,type="II")
summary(SESDinter.inter.lm)
summaryBy(SubDist~SubDistCond,FUN = c(mean,sd), data = VCU, na.rm=TRUE)
plot(allEffects(SESDinter.inter.lm))
...
Anova(SESDinter.inter.lm,type="II")
summary(SESDinter.inter.lm)
summaryBy(SubDist~SubDistCond,FUN = c(mean,sd), data = mTurk, na.rm=TRUE)
plot(allEffects(SESDinter.inter.lm))
...
###PLU
PLU<-subset(SESDdata,Site=="PacificLutheranUniversity")
head(PLU)
PLU.lm<-lm(SubDist~MonthsSince+SubDistCond*SelfEsteem*DaysInComp,data=SESDdata)
