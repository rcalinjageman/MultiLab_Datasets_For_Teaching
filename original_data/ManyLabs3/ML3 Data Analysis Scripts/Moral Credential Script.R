...
etaSquared(Credential.inter.lm)
...
AttentionCheck<-lm(mcdv1~CredCond*Genderfactor*AttentionCheck,data=ML3)
Anova(AttentionCheck,type="II")
modelEffectSizes(AttentionCheck)
ci.pvaf(F.value= 0.1294,df.1=1,df.2=3110,N=3118,conf.level=.95)
ci.pvaf(F.value= 0.1345,df.1=1,df.2=3110,N=3118,conf.level=.95)
...
Anova(Credential.inter.lm,type="II")
summary(Credential.inter.lm)
etaSquared(Credential.inter.lm)
plot(allEffects(Credential.inter.lm))
summaryBy(mcdv1~CredCond,data=Ashland)
...
etaSquared(Credential.inter.lm)
summary(Credential.inter.lm)
summaryBy(mcdv1~CredCond,data=Bradley)
...
Anova(Credential.inter.lm,type="II")
summary(Credential.inter.lm)
summaryBy(mcdv1~CredCond,data=Carleton)
...
Anova(Credential.inter.lm,type="II")
summary(Credential.inter.lm)
summaryBy(mcdv1~CredCond,data=Ithaca)
plot(allEffects(Credential.inter.lm))
...
Anova(Credential.inter.lm,type="II")
summary(Credential.inter.lm)
summaryBy(mcdv1~CredCond,data=Miami)
...
Anova(Credential.inter.lm,type="II")
summary(Credential.inter.lm)
summaryBy(mcdv1~CredCond,data=MichSt)
...
Anova(Credential.inter.lm,type="II")
summary(Credential.inter.lm)
summaryBy(mcdv1~CredCond,data=Montana)
...
Anova(Credential.inter.lm,type="II")
summary(Credential.inter.lm)
summaryBy(mcdv1~CredCond,data=Nova,na.rm=TRUE)
...
Anova(Credential.inter.lm,type="II")
summary(Credential.inter.lm)
summaryBy(mcdv1~CredCond,data=OSU)
...
Anova(Credential.inter.lm,type="II")
summary(Credential.inter.lm)
summaryBy(mcdv1~CredCond,data=PLU)
plot(allEffects(Credential.inter.lm))
...
Anova(Credential.inter.lm,type="II")
summary(Credential.inter.lm)
summaryBy(mcdv1~CredCond,data=Penn)
...
Anova(Credential.inter.lm,type="II")
summary(Credential.inter.lm)
summaryBy(mcdv1~CredCond,data=SDSU)
...
Anova(Credential.inter.lm,type="II")
summary(Credential.inter.lm)
summaryBy(mcdv1~CredCond,data=Texas)
...
Anova(Credential.inter.lm,type="II")
summary(Credential.inter.lm)
summaryBy(mcdv1~CredCond,data=Davis)
...
Anova(Credential.inter.lm,type="II")
summary(Credential.inter.lm)
summaryBy(mcdv1~CredCond,data=Riverside)
...
Anova(Credential.inter.lm,type="II")
summary(Credential.inter.lm)
summaryBy(mcdv1~CredCond,data=Florida,na.rm=TRUE)
...
Anova(Credential.inter.lm,type="II")
summary(Credential.inter.lm)
summaryBy(mcdv1~CredCond,data=Mississippi)
...
Anova(Credential.inter.lm,type="II")
summary(Credential.inter.lm)
summaryBy(mcdv1~CredCond,data=Toronto)
...
Anova(Credential.inter.lm,type="II")
summary(Credential.inter.lm)
summaryBy(mcdv1~CredCond,data=Virginia,na.rm=TRUE)
...
Anova(Credential.inter.lm,type="II")
summary(Credential.inter.lm)
summaryBy(mcdv1~CredCond,data=VCU)
...
Anova(Credential.inter.lm,type="II")
summary(Credential.inter.lm)
summaryBy(mcdv1~CredCond,data=mTurk,na.rm=TRUE)
...
head(PLU)
PLU.lm<-lm(mcdv1~CredCond*Genderfactor*DaysInComp,data=PLU)
Anova(PLU.lm,type="II")


###Checking inter-site variation
str(ML3$Site)
ML3$Site<-as.factor(ML3$Site)
Check<-lm(mcdv1~CredCond*Site,data=ML3)
Anova(Check,type="II")
