...
AttentionCheck<-glm(AvailSign~AttentionCheck,data=ML3,family=binomial)
Anova(AttentionCheck,type="II")
chies(4.5914,3088)
plot(allEffects(AttentionCheck))
...
head(PLU)
str(PLU$AvailSign)
PLU$AvailSign<-as.factor(PLU$AvailSign)
PLU.glm<-glm(AvailSign~DaysInComp,data=PLU,family=binomial)
