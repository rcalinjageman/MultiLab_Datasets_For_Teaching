...
AttentionCheck<-lm(Persistence~Conscientiousness*AttentionCheck,data=ML3)
Anova(AttentionCheck,type="II")
ci.pvaf(F.value= 0.9619,df.1=1,df.2=3163,N=3167,conf.level=.95)
...
head(PLU)
PLU.lm<-lm(Persistence~Conscientiousness*DaysInComp,data=PLU)
