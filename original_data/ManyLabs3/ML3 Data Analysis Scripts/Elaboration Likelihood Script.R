...
#modelEffectSizes doesn't seem to work anymore, so using etaSquared command
etaSquared(ELM.lm)
...
summaryBy(ArgumentQuality~ELMCond,FUN = c(mean,sd), data = Ashland, na.rm=TRUE)
plot(allEffects(ELM.inter.lm))
...
Anova(ELM.inter.lm,type="II")
summary(ELM.inter.lm)
summaryBy(ArgumentQuality~ELMCond,FUN = c(mean,sd), data = Bradley, na.rm=TRUE)
plot(allEffects(ELM.inter.lm))
...
Anova(ELM.inter.lm,type="II")
summary(ELM.inter.lm)
summaryBy(ArgumentQuality~ELMCond,FUN = c(mean,sd), data = Carleton, na.rm=TRUE)
plot(allEffects(ELM.inter.lm))
...
Anova(ELM.inter.lm,type="II")
summary(ELM.inter.lm)
summaryBy(ArgumentQuality~ELMCond,FUN = c(mean,sd), data = Ithaca, na.rm=TRUE)
plot(allEffects(ELM.inter.lm))
...
Anova(ELM.inter.lm,type="II")
summary(ELM.inter.lm)
summaryBy(ArgumentQuality~ELMCond,FUN = c(mean,sd), data = Miami, na.rm=TRUE)
plot(allEffects(ELM.inter.lm))
...
Anova(ELM.inter.lm,type="II")
summary(ELM.inter.lm)
summaryBy(ArgumentQuality~ELMCond,FUN = c(mean,sd), data = MichSt, na.rm=TRUE)
plot(allEffects(ELM.inter.lm))
...
Anova(ELM.inter.lm,type="II")
summary(ELM.inter.lm)
summaryBy(ArgumentQuality~ELMCond,FUN = c(mean,sd), data = Montana, na.rm=TRUE)
plot(allEffects(ELM.inter.lm))
...
Anova(ELM.inter.lm,type="II")
summary(ELM.inter.lm)
summaryBy(ArgumentQuality~ELMCond,FUN = c(mean,sd), data = Nova, na.rm=TRUE)
plot(allEffects(ELM.inter.lm))
...
Anova(ELM.inter.lm,type="II")
summary(ELM.inter.lm)
summaryBy(ArgumentQuality~ELMCond,FUN = c(mean,sd), data = OSU, na.rm=TRUE)
plot(allEffects(ELM.inter.lm))
...
Anova(ELM.inter.lm,type="II")
summary(ELM.inter.lm)
summaryBy(ArgumentQuality~ELMCond,FUN = c(mean,sd), data = PLU, na.rm=TRUE)
plot(allEffects(ELM.inter.lm))
...
Anova(ELM.inter.lm,type="II")
summary(ELM.inter.lm)
summaryBy(ArgumentQuality~ELMCond,FUN = c(mean,sd), data = Penn, na.rm=TRUE)
plot(allEffects(ELM.inter.lm))
...
Anova(ELM.inter.lm,type="II")
summary(ELM.inter.lm)
summaryBy(ArgumentQuality~ELMCond,FUN = c(mean,sd), data = SDSU, na.rm=TRUE)
plot(allEffects(ELM.inter.lm))
...
Anova(ELM.inter.lm,type="II")
summary(ELM.inter.lm)
summaryBy(ArgumentQuality~ELMCond,FUN = c(mean,sd), data = Texas, na.rm=TRUE)
plot(allEffects(ELM.inter.lm))
...
Anova(ELM.inter.lm,type="II")
summary(ELM.inter.lm)
summaryBy(ArgumentQuality~ELMCond,FUN = c(mean,sd), data = Davis, na.rm=TRUE)
plot(allEffects(ELM.inter.lm))
...
Anova(ELM.inter.lm,type="II")
summary(ELM.inter.lm)
summaryBy(ArgumentQuality~ELMCond,FUN = c(mean,sd), data = Riverside, na.rm=TRUE)
plot(allEffects(ELM.inter.lm))
...
Anova(ELM.inter.lm,type="II")
summary(ELM.inter.lm)
summaryBy(ArgumentQuality~ELMCond,FUN = c(mean,sd), data = Florida, na.rm=TRUE)
plot(allEffects(ELM.inter.lm))
...
Anova(ELM.inter.lm,type="II")
summary(ELM.inter.lm)
summaryBy(ArgumentQuality~ELMCond,FUN = c(mean,sd), data = Mississippi, na.rm=TRUE)
plot(allEffects(ELM.inter.lm))
...
Anova(ELM.inter.lm,type="II")
summary(ELM.inter.lm)
summaryBy(ArgumentQuality~ELMCond,FUN = c(mean,sd), data = Toronto, na.rm=TRUE)
plot(allEffects(ELM.inter.lm))
...
Anova(ELM.inter.lm,type="II")
summary(ELM.inter.lm)
summaryBy(ArgumentQuality~ELMCond,FUN = c(mean,sd), data = Virginia, na.rm=TRUE)
plot(allEffects(ELM.inter.lm))
...
Anova(ELM.inter.lm,type="II")
summary(ELM.inter.lm)
summaryBy(ArgumentQuality~ELMCond,FUN = c(mean,sd), data = VCU, na.rm=TRUE)
plot(allEffects(ELM.inter.lm))
...
###Revision analyses###
ML3$NFCceneter<-as.numeric(ML3$NFCceneter)
