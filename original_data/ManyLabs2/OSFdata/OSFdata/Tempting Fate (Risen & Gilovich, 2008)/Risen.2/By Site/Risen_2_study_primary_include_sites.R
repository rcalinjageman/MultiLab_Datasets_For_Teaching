...
##
## Tempting Fate (Risen & Gilovich, 2008): Risen_2_study_primary_include_sites
##
...
analysis.unique.id     <- 51
analysis.name          <- 'Risen.2'
analysis.type          <- 3
...
# To see the function code type:varfun.Risen.2, or lookup in manylabRs_SOURCE.R
ML2.var[[g]] <- varfun.Risen.2(ML2.sr[[g]])
...
stat.test   <- try.CATCH(with(ML2.var[[g]],anova(lm(Likelihood ~ Condition*Gender))))
