...
##
## Direction & SES (Huang et al., 2014): Huang_2_study_secondary_include_sites
##
...
analysis.unique.id     <- 2
analysis.name          <- 'Huang.2'
analysis.type          <- 3
...
ML2.df <- ML2.df  %>% dplyr::select(1,6,149,150,156,157,429,520,521,522,523,524,525,526,527,528,529,530,531,534,535,536) %>% dplyr::filter(is.character(source))
