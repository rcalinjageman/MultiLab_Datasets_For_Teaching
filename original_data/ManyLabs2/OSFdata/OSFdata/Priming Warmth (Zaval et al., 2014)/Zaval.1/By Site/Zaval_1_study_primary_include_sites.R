...
##
## Priming Warmth (Zaval et al., 2014): Zaval_1_study_primary_include_sites
##
...
analysis.unique.id     <- 75
analysis.name          <- 'Zaval.1'
analysis.type          <- 3
...
ML2.df <- ML2.df  %>% dplyr::select(1,6,428,804,903,904,905,906,907,908,909,910,911,912,913,914,930,932,937,938,939) %>% dplyr::filter(is.character(source))
