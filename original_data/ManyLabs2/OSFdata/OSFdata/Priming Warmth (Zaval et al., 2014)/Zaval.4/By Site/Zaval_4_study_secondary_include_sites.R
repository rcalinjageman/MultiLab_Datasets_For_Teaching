...
##
## Priming Warmth (Zaval et al., 2014): Zaval_4_study_secondary_include_sites
##
...
analysis.unique.id     <- 78
analysis.name          <- 'Zaval.4'
analysis.type          <- 3
...
ML2.df <- ML2.df  %>% dplyr::select(1,6,429,804,903,904,905,906,907,908,909,910,911,912,913,914,930,932,937,938,939) %>% dplyr::filter(Language=="English" )
