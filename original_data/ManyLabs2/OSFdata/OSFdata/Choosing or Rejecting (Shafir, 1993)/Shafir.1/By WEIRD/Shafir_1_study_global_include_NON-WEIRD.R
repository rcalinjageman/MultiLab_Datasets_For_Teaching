...
##
## Choosing or Rejecting (Shafir, 1993): Shafir_1_study_global_include_NON-WEIRD
##
...
ML2.df <- ML2.df  %>% dplyr::select(1,6,285,290,804,903,904,905,906,907,908,909,910,911,912,913,914,937,938,939) %>% dplyr::filter(is.character(source) & (Weird == 0))
