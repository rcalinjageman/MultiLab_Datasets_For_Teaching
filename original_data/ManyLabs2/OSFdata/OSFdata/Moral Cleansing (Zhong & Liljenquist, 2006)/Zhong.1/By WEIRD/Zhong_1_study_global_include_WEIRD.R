...
##
## Moral Cleansing (Zhong & Liljenquist, 2006): Zhong_1_study_global_include_WEIRD
##
...
ML2.df <- ML2.df  %>% dplyr::select(1,6,227,228,229,230,231,232,233,234,235,236,804,903,904,905,906,907,908,909,910,911,912,913,914,933,934,937,938,939) %>% dplyr::filter(is.character(source) & (Weird == 1))
