...
##
## Moral Cleansing (Zhong & Liljenquist, 2006): Zhong_3_study_primary_include_sites
##
...
analysis.unique.id     <- 67
analysis.name          <- 'Zhong.3'
analysis.type          <- 3
...
# To see the function code type:varfun.Zhong.3, or lookup in manylabRs_SOURCE.R
ML2.var[[g]] <- varfun.Zhong.3(ML2.sr[[g]])
