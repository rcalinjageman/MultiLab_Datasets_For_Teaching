...
##
## Actions are Choices (Savani et al., 2010): Savani_1a_study_primary_include_sites
##
...
analysis.unique.id     <- 53
analysis.name          <- 'Savani.1a'
analysis.type          <- 3
...
ML2.df <- ML2.df  %>% dplyr::select(1,6,30,31,37,38,45,46,53,54,61,62,69,70,76,77,83,84,95,96,102,103,110,111,118,119,126,127,134,135,141,142,148,149,804,903,904,905,906,907,908,909,910,911,912,913,914,937,938,939) %>% dplyr::filter(SubjectPool == "Yes" )
