...
##
## Correspondence Bias (Miyamoto & Kitayama, 2002): Miyamoto_2_study_primary_include_sites
##
...
analysis.unique.id     <- 23
analysis.name          <- 'Miyamoto.2'
analysis.type          <- 3
...
ML2.df <- ML2.df  %>% dplyr::select(1,6,50,56,78,84,520,521,522,523,524,525,526,527,528,529,530,531,534,535,536) %>% dplyr::filter(is.character(source))
