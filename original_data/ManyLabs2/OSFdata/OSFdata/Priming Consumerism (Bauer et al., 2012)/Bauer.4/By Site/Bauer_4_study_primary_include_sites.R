...
##
## Priming Consumerism (Bauer et al., 2012): Bauer_4_study_primary_include_sites
##
...
analysis.unique.id     <- 20
analysis.name          <- 'Bauer.4'
analysis.type          <- 3
...
ML2.df <- ML2.df  %>% dplyr::select(1,6,276,281,290,520,521,522,523,524,525,526,527,528,529,530,531,534,535,536) %>% dplyr::filter(is.character(source))
