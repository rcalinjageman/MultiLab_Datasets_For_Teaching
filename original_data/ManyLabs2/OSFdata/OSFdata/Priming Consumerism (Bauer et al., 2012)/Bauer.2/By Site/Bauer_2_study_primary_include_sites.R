...
##
## Priming Consumerism (Bauer et al., 2012): Bauer_2_study_primary_include_sites
##
...
analysis.unique.id     <- 18
analysis.name          <- 'Bauer.2'
analysis.type          <- 3
...
ML2.df <- ML2.df  %>% dplyr::select(1,6,276,281,287,520,521,522,523,524,525,526,527,528,529,530,531,534,535,536) %>% dplyr::filter(is.character(source))
