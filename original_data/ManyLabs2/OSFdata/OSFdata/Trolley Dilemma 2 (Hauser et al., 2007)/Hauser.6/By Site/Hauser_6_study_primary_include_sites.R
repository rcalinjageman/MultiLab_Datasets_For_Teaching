...
##
## Trolley Dilemma 2 (Hauser et al., 2007): Hauser_6_study_primary_include_sites
##
...
analysis.unique.id     <- 49
analysis.name          <- 'Hauser.6'
analysis.type          <- 3
...
ML2.df <- ML2.df  %>% dplyr::select(1,6,199,202,204,209,212,214,804,903,904,905,906,907,908,909,910,911,912,913,914,937,938,939) %>% dplyr::filter(is.character(source))
