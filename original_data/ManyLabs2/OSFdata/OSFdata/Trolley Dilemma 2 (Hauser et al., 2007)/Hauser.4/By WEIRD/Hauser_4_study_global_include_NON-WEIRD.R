...
##
## Trolley Dilemma 2 (Hauser et al., 2007): Hauser_4_study_global_include_NON-WEIRD
##
...
ML2.df <- ML2.df  %>% dplyr::select(1,6,199,202,209,212,804,903,904,905,906,907,908,909,910,911,912,913,914,937,938,939) %>% dplyr::filter(is.character(source) & (Weird == 0))
