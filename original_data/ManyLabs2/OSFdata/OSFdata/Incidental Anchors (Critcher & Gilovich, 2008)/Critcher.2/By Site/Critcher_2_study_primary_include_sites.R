...
##
## Incidental Anchors (Critcher & Gilovich, 2008): Critcher_2_study_primary_include_sites
##
...
analysis.unique.id     <- 37
analysis.name          <- 'Critcher.2'
analysis.type          <- 3
...
ML2.df <- ML2.df  %>% dplyr::select(1,6,296,301,520,521,522,523,524,525,526,527,528,529,530,531,534,535,536) %>% dplyr::filter(Pencil=="Yes, participants completed the Critcher task on pencil and paper" )
