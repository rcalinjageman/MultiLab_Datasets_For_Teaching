...
##
## Intuitive Reasoning (Norenzayan et al., 2002): Norenzayan_2_study_primary_include_sites
##
...
analysis.unique.id     <- 60
analysis.name          <- 'Norenzayan.2'
analysis.type          <- 3
...
# To see the function code type:varfun.Norenzayan.2, or lookup in manylabRs_SOURCE.R
ML2.var[[g]] <- varfun.Norenzayan.2(ML2.sr[[g]])
...
stat.test   <- try.CATCH(with(ML2.var[[g]],summary(lm(Response ~ Condition * Order))))
