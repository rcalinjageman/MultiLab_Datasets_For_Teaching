...
##
## Trolley Dilemma 1 (Hauser et al., 2007): Hauser_2_study_primary_include_sites
##
...
analysis.unique.id     <- 40
analysis.name          <- 'Hauser.2'
analysis.type          <- 3
...
ML2.df <- ML2.df  %>% dplyr::select(1,6,180,181,185,190,191,195,520,521,522,523,524,525,526,527,528,529,530,531,534,535,536) %>% dplyr::filter(is.character(source))
