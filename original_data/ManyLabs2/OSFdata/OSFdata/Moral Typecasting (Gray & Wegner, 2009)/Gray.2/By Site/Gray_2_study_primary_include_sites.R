...
##
## Moral Typecasting (Gray & Wegner, 2009): Gray_2_study_primary_include_sites
##
...
analysis.unique.id     <- 63
analysis.name          <- 'Gray.2'
analysis.type          <- 3
...
ML2.df <- ML2.df  %>% dplyr::select(1,6,641,649,804,903,904,905,906,907,908,909,910,911,912,913,914,937,938,939) %>% dplyr::filter(is.character(source))
