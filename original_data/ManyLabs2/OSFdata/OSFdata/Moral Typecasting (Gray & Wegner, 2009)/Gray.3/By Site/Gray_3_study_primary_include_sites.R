...
##
## Moral Typecasting (Gray & Wegner, 2009): Gray_3_study_primary_include_sites
##
...
analysis.unique.id     <- 64
analysis.name          <- 'Gray.3'
analysis.type          <- 3
...
ML2.df <- ML2.df  %>% dplyr::select(1,6,642,650,804,903,904,905,906,907,908,909,910,911,912,913,914,937,938,939) %>% dplyr::filter(is.character(source))
