...
##
## Moral Foundations (Graham et al., 2009): Graham_1_study_global_include_NON-WEIRD
##
...
ML2.df <- ML2.df  %>% dplyr::select(1,6,135,136,137,138,139,140,141,142,143,430,520,521,522,523,524,525,526,527,528,529,530,531,534,535,536) %>% dplyr::filter(is.character(source) & (Weird == 0))
