...
##
## Assimilation & Contrast (Schwarz et al., 1991): Schwarz_2c_study_primary_include_sites
##
...
analysis.unique.id     <- 73
analysis.name          <- 'Schwarz.2c'
analysis.type          <- 3
...
# To see the function code type:varfun.Schwarz.2, or lookup in manylabRs_SOURCE.R
ML2.var[[g]] <- varfun.Schwarz.2(ML2.sr[[g]])
...
stat.test   <- try.CATCH(with(ML2.var[[g]],cor_test_fisherZ(r1=r2,r2=NULL,n1=N[2],n2=NULL, conf.level=stat.params$conf.level, alternative = stat.params$alternative)))
