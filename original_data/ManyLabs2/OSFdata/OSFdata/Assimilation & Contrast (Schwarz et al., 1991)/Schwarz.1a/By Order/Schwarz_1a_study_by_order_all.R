...
##
## Assimilation & Contrast (Schwarz et al., 1991): Schwarz_1a_study_by_order_all
##
...
ML2.df <- ML2.df  %>% dplyr::select(1,6,265,270,275,280,804,903,904,905,906,907,908,909,910,911,912,913,914,937,938,939) %>% dplyr::filter(is.character(source))
...
# To see the function code type:varfun.Schwarz.1, or lookup in manylabRs_SOURCE.R
...
stat.test   <- try.CATCH(with(ML2.var[[g]],cor_test_fisherZ(r1=r1,r2=r2,n1=N[1],n2=N[2], conf.level=stat.params$conf.level, alternative = stat.params$alternative)))
