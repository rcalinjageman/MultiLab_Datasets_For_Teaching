...
##
## Assimilation & Contrast (Schwarz et al., 1991): Schwarz_2b_study_primary_include_sites
##
...
analysis.unique.id     <- 72
analysis.name          <- 'Schwarz.2b'
analysis.type          <- 3
...
stat.test   <- try.CATCH(with(ML2.var[[g]],cor_test_fisherZ(r1=r1,r2=NULL,n1=N[1],n2=NULL, conf.level=stat.params$conf.level, alternative = stat.params$alternative)))
