...
##
## False Consensus 1 (Ross et al., 1977): Ross_1_study_global_include_WEIRD
##
...
ML2.df <- ML2.df  %>% dplyr::select(1,6,23,29,520,521,522,523,524,525,526,527,528,529,530,531,534,535,536) %>% dplyr::filter(is.character(source) & (Weird == 1))
