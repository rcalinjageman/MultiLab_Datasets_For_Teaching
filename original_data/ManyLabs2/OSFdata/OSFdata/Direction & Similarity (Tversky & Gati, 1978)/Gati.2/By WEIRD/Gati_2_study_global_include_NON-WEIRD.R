...
##
## Direction & Similarity (Tversky & Gati, 1978): Gati_2_study_global_include_NON-WEIRD
##
...
ML2.df <- ML2.df  %>% dplyr::select(1,6,708,709,710,711,712,713,714,715,716,717,718,719,720,721,722,723,724,725,726,727,728,734,735,736,737,738,739,740,741,742,743,744,745,746,747,748,749,750,751,752,753,754,804,903,904,905,906,907,908,909,910,911,912,913,914,937,938,939) %>% dplyr::filter(is.character(source) & (Weird == 0))
