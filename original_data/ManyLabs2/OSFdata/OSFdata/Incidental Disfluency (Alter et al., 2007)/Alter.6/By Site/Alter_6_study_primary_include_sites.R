...
##
## Incidental Disfluency (Alter et al., 2007): Alter_6_study_primary_include_sites
##
...
analysis.unique.id     <- 13
analysis.name          <- 'Alter.6'
analysis.type          <- 3
...
# To see the function code type:varfun.Alter.4, or lookup in manylabRs_SOURCE.R
ML2.var[[g]] <- varfun.Alter.4(ML2.sr[[g]])
