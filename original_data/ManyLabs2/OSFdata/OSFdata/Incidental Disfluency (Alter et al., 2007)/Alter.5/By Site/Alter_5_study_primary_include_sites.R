...
##
## Incidental Disfluency (Alter et al., 2007): Alter_5_study_primary_include_sites
##
...
analysis.unique.id     <- 12
analysis.name          <- 'Alter.5'
analysis.type          <- 3
...
ML2.df <- ML2.df  %>% dplyr::select(1,6,313,314,315,316,317,318,326,327,328,329,330,331,520,521,522,523,524,525,526,527,528,529,530,531,534,535,536) %>% dplyr::filter(is.character(source))
...
# To see the function code type:varfun.Alter.3, or lookup in manylabRs_SOURCE.R
ML2.var[[g]] <- varfun.Alter.3(ML2.sr[[g]])
