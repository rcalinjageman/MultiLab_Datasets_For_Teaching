...
##
## Disgust & Homophobia (Inbar et al., 2009): Inbar_2c_study_primary_include_sites
##
...
analysis.unique.id     <- 31
analysis.name          <- 'Inbar.2c'
analysis.type          <- 3
...
ML2.df <- ML2.df  %>% dplyr::select(1,6,165,174,381,382,388,389,390,520,521,522,523,524,525,526,527,528,529,530,531,534,535,536) %>% dplyr::filter(is.character(source))
