...
##
## Disgust & Homophobia (Inbar et al., 2009): Inbar_3c_study_primary_include_sites
##
...
analysis.unique.id     <- 34
analysis.name          <- 'Inbar.3c'
analysis.type          <- 3
...
ML2.df <- ML2.df  %>% dplyr::select(1,6,166,175,381,382,388,389,390,520,521,522,523,524,525,526,527,528,529,530,531,534,535,536) %>% dplyr::filter(is.character(source))
