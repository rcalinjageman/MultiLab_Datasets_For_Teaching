...
##
## Disgust & Homophobia (Inbar et al., 2009): Inbar_1a_study_global_include_NON-WEIRD
##
...
ML2.df <- ML2.df  %>% dplyr::select(1,6,164,173,381,382,388,389,390,520,521,522,523,524,525,526,527,528,529,530,531,534,535,536) %>% dplyr::filter(is.character(source) & (Weird == 0))
